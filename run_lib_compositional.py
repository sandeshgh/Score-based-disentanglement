...
import losses
import sampling, sampling_multivariate
...
def train(config, workdir):
  ...
  train_step_fn = losses.get_step_fn(sde, train=True, optimize_fn=optimize_fn,
                                     ...
                                     likelihood_weighting=likelihood_weighting, compositional=config.training.compositional, beta=None)
  eval_step_fn = losses.get_step_fn(sde, train=False, optimize_fn=optimize_fn,
                                    reduce_mean=reduce_mean, continuous=continuous,
                                    likelihood_weighting=likelihood_weighting, compositional = config.training.compositional)
