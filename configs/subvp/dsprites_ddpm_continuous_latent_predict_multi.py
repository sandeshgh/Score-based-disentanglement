...
def get_config():
  ...
  training.forward_diffusion = 'predict_multi'
  ...
  # model
  model = config.model
  model.name = 'ddpm_latent_aniso_multi'
  model.spectral_model_name = 'encode_resnet_multi'
  ...
  config.eval.begin_ckpt = 35
  config.eval.end_ckpt = 36
