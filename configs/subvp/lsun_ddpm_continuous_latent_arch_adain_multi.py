...
def get_config():
  ...
  training.ortho_loss = False
  training.regularization = None
  training.batch_size = 32
  training.snapshot_freq = 20000#10000 #5000
  ...
  data.centered = True
  data.image_size = 48
  data.tfrecords_path = '/home/sandesh/Score_generative/progressive_gan_data_tools/datasets/lsun_church/lsun_church-r07.tfrecords'
  ...
  config.eval.end_ckpt = 4
  config.eval.batch_size = 16
  config.eval.analysis_type = 'uncond' #'tune'#'close'#'tune'#
